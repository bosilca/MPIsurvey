...
T <- read.table("ExaMPI-SC20/Data/timeline.csv",header=TRUE,sep=";")

T$X <-as.Date(T$X,tryFormats="%d/%m/%Y")
...
# save plot 
ggsave("./ExaMPI-SC20/R-scripts/TimeSeries.pdf",height=10,width=20)
