...
prioritize? Or $\cdots$'' (Fig.~\ref{fig:missing-features}), and Q26 asking
...
the least satisfied with the current situation and Russia which are
...
efficiently the topology and the locality seem a major concern to many users. Then
...
simpler and easier API would be desirable (a topic where the
discrepancy between different regions is minimal).
