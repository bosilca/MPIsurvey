...
country and/or region where he belongs. For the design of the questionnaire,
...
17th of February 2019 and it is still open. The most recent answer was
...
questions single-answer questions and multiple-answers questions
...
participants from China and his answer was because of their
nationality.
\todo[inline]{EJ: I do not understand why the nationality of chinese
...
\todo[inline]{EJ: "your" applications. To be corrected in many places}
...
The low percentage shown in Fig.~\ref{fig:using-mpi-aspects} is
...
the use the dynamic process creation hard and impractical for MPI users.
