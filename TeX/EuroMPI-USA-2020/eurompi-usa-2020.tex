...
\begin{figure}[htb]%
  \begin{center}%
   \includegraphics[width=0.8\hsize]{figs/ECP.pdf}
    \caption{Comparison of the results between ours (overall and USA
      only) and ECP on asking using MPI aspects}
...
\comment{Due to the page limit, only few of some of the most
