...
% simply add a long related work section or more discussion. The
% papers must have a decent update all over and have new content
% (e.g., results, algorithms) over the original. 
% 
...
\comment{
  ...
  \begin{figure}[htb]
    \begin{center}
      \includegraphics[width=7.5cm]{R-scripts/Q13.pdf}
