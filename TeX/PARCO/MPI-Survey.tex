...
\cite{https://doi.org/10.1002/cpe.5901}. The [R]
class surveys are
...
In the [R] category, \cite{8665758} collected and
...
~\ref{app:questions}.
\comment{
  Importantly, we have two kind of
...
three major countries, USA, China and Japan, are not even in the top 5
of out survey. Especially China has only 18 participants including
...
{\noindent\small [dataset][15] A. Hori, T. Ogura, E. Jeannot, G. Bosilca, MPI
International Survey – GitHub Repository,
\url{https://exascaleproject.org/}, 2021.} 
