...
each major \country and the number of the major contributors in the
...
\end{enumerate*}. % a space is intentionally put
...
\subsection{MPI Implementations}
  ...
  \mcountries and regions, followed by MVAPICH. A large disparity can be
...
group dominates in most \mcountries and regions (excepting Russia),
