...
generate_graph <- function(input_csv = "./dat/Q7-simple.csv", 
                           output_pdf = "./PARCO/Review/R-scripts/Q7.pdf", 
...
generate_graph(input_csv = "./dat/Q12-simple.csv", 
               output_pdf = "./PARCO/Review/R-scripts/Q12.pdf", 
...
generate_graph(input_csv = "./dat/Q14-simple.csv", 
               output_pdf = "./PARCO/Review/R-scripts/Q14.pdf", 
...
generate_graph(input_csv = "./dat/Q17-simple.csv", 
               output_pdf = "./PARCO/Review/R-scripts/Q17.pdf", 
...
generate_graph(input_csv = "./dat/Q19-simple.csv", 
               output_pdf = "./PARCO/Review/R-scripts/Q19.pdf", 
...
generate_graph(input_csv = "./dat/Q26-simple.csv", 
               output_pdf = "./PARCO/Review/R-scripts/Q26.pdf", 
