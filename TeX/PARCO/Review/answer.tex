...
\newcommand{\emmanuel}[1]{\todo[size=\small,inline,color=cyan]{#1 \-- Emmanuel}}
...
\response{
  ...
  still think the paper adds some value to the community.}
         {This paper is a survey paper based on a traditional
           ...
           common and there is no new technical insights in this
           paper.
           \emmanuel{I would remove `` and there is no new technical insights in this
           paper''.}
...
\response{The authors present the results and an in-depth discussion
 ...
 {
Our developed Python program 
produces a number of heat map graphs of any possible combinations of two
...
paper. The number of meaningful heatmap graphs is not large.
 }
\emmanuel{Do we want to state that we support open science and that
  all the data are available on github?}
  ...
  target for a specific batch of questions.}
{
  ...
  \emmanuel{I would change the above sentence by :''We did not created
    a new methodology for this work.''}  
...
{We don't understand how this answer is related to the questions
  above. We are sorry we cannot go into more details here because none of us
