...
\caption{Q19: Learning Obstacles - Text mining of \myquote{Other} free
text}
...
(using WordCloud\cite{wordcloud}\footnote{WordCloud parameters: \tt
  stopwords=None, min\_word\_length=4, collocations=True,
  collocation\_threshold=5, max\_words=30}).
